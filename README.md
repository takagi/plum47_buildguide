### スタビライザー使用時のスペースバーの干渉について

トッププレートの工作精度の関係で、スタビライザーを使用したとき、キーキャップとの相性によってはスペースバーがスムーズに上下しない場合があることが分かりました。

そのようなケースに該当された方は、無償で再製造版のトッププレートをお送りしますので、kamonama@gmail.com までご連絡ください。2020年11月上旬にお送りできる予定です。

なお、スタビライザーを使用しない場合は、そのまま問題なくお使いいただけます。
